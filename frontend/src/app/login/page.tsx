...
export default function LoginPage() {
  ...
  return (
    <div className="tf-login-shell relative flex h-screen w-full flex-col items-center justify-center overflow-hidden text-[#e8ebff]">
      <BackgroundVideo />

      <div className="relative z-10 mt-[-4vh] w-full max-w-md px-6 text-center sm:px-8">
        <div className="tf-login-card rounded-[1.35rem] px-8 py-10 sm:px-10">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative h-28 w-28 animate-float-soft drop-shadow-[0_0_40px_rgba(122,121,255,0.35)]">
          ...
          <p className="mb-10 text-lg leading-relaxed text-[#b3bad5]">
          ...
          <button
            ...
            className="tf-google-button group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-white px-6 py-4 text-base font-medium text-black transition-transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:hover:scale-100"
          >
          ...
          <p className="mt-8 text-sm text-[#7f89ad]">
